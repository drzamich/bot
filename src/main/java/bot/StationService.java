...
public class StationService {
    ...
    public String getInformation(String msg) {
        ...
        return station.getStationName() + " " + platform.getPlatformId();
    ...
    private String getInfoAboutDepartures(String platformId){
        return "Error when getting info about departures";
    }
}
