...
@Service
@Data
public class ApiUmStationService extends DataManager {
    private Station station;
    private List<Platform> platforms;
    private List<PlatformDepartureInfo> platformDepartureInfos = new ArrayList<>();
    private List<String> msg;
    private ApiUmDepartureService departureService;


    public ApiUmStationService(){
        super();
    }

    public ApiUmStationService(List<String> msg) {
        super();
        this.msg = msg;
//        this.findStation();
//        this.findPlatforms();
    ...
    public ApiUmStationService(Station station) {
        super();
